...
export class HomeComponent implements OnInit {
    ...
    //         title: 'Stray',
    //         description:
    //             'زیر و بم شهر در زیر پنجه های شماست! دز این بازی از دید یک گربه به گشت‌وگذار در شهر می‌پردازیم.',
    //         price: 220,
    //     },
    //     {
    ...
    //         title: 'Saints Row',
    //         description:
    //             'سینتز رو با یه ریبوت جدید امسال برمیگرده. تو دنیای جهان باز شهر لوس ایلیو با گنگ خودتون هر کاری بخواید می‌تونید بکنید.',
    //         price: 390,
    //     },
    // ];
}
